...
vector<VertexBufferObjectAttribs *> Mesh::obj(const QString &fileName, const vec3 &rot, const vec3 &scale, GLenum primitive)
{
...
VertexBufferObjectAttribs *Mesh::quadLines(int startX, int startY, int width, int height, const vec4 &color)
{
...
VertexBufferObjectAttribs *Mesh::quad(int startX, int startY, int width, int height, const vec4 &color, GLenum primitive)
{
	vec3 mi(startX, startY, 0.0f);
	vec3 ma(startX + width, startY + height, 0.0f);
...
VertexBufferObjectAttribs *Mesh::quad(int width, int height, const vec4 &color, GLenum primitive)
{
...
VertexBufferObjectAttribs *Mesh::box(const vec3 &mi, const vec3 &ma, const vec4 &color, GLenum primitive)
{
    vector<vec3> vertices;
    vector<vec3> normals;
...
VertexBufferObjectAttribs *Mesh::sphere(float radius, int iterations, const vec4 &color, GLenum primitive)
{

...
void Camera::update()
{
	...
	//m_pos.print();
	//qDebug() << m_heading << m_pitch << m_roll;
...
void Camera::render(const Transform &trans, const GlobalObjectParam &param)
{
...
void Camera::loadFrames(QString filePath)
{
     ...
     {
         qDebug() << "Camera::loadFrames() -> No Camera File available";
         return;
     }
